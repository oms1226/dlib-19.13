...
//    (filepath + directoryName + "test1_1/"),
    (filepath + directoryName + "55/")
//
//    (filepath + directoryName + "13/"),
//    (filepath + directoryName + "14/"),
//    (filepath + directoryName + "15/"),
//    (filepath + directoryName + "16/"),
//    (filepath + directoryName + "17/"),
//    (filepath + directoryName + "18/"),
//    (filepath + directoryName + "19/"),
//    (filepath + directoryName + "20/"),
...
//	        std::string newfile = "/Users/hongkeunyoo/Documents/Dlib\ FaceDetection/training_add/images_added/new_frontal_20180229/new_face_keun2.svm";
